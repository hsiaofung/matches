...
//桌機衣櫃光箱 彥如
	...
	var clothesLightbox = document.getElementsByClassName("me_cloth_LB_bg");
	var clothesLightboxClose = document.getElementsByClassName("me_cloth_x");
	
	function showClothes(){
		clothesLightbox[0].style.display = "block";
	}

	clothes.onclick = showClothes;

	// clothesLightboxClose.onclick = closeClothesLightBox;

//jquery  關掉衣櫃光箱的叉叉叉叉叉叉
	$('.me_cloth_x').click(function(){
		$('.me_cloth_LB_bg').css('display','none');
	});
//手機衣櫃光箱 彥如
	$('#mobile_clothes').click(function(){
		$('.me_cloth_LB_bg').css('display','block');
	});

//桌機 小武郎   光箱
	var letter = document.getElementById("letter");
	var me_msg = document.getElementsByClassName("me_msg");

	function showLetterBox(){
		me_msg[0].style.display = "block";
	}

	letter.onclick = showLetterBox;

//手機 小武郎 光箱
	$('#mobile_letter').click(function(){
		$('.me_msg').css('display','');
	});
